...
function createValidWorkspaceState() {
  ...
  const summary = summarize({
    ...
    laborBurdenPct: baseProject.labor_burden_pct,
    smallToolsPct: baseProject.small_tools_pct,
    contingencyPct: baseProject.contingency_pct,
    escalationPct: baseProject.escalation_pct,
    bondPct: baseProject.bond_pct,
